    ...
    return (
        <>
            ...
            <button
                ...
                className="fixed top-4 left-4 z-50 md:hidden bg-white p-2 rounded-lg shadow-lg border border-zinc-200"
            >
                {mobileMenuOpen ? (
                    <X className="h-6 w-6" />
                ) : (
            ...
            >
                <div className="flex flex-col h-full">
                    ...
                    <div className="flex items-center h-16 px-6 border-b border-zinc-200">
                        <h1 className="text-lg font-semibold">Berejena Studio</h1>
                    </div>
